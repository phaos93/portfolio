...
export const aboutText = {
  pt: [
    ...
    "Hoje, com mais de 3 anos de experiência, trabalho diariamente com TypeScript, React, Next.js, Node.js e serviços em nuvem. Acredito que o melhor código é aquele que resolve problemas reais de forma simples e escalável.",
  ],
  en: [
    ...
    "Today, with over 3 years of experience, I work daily with TypeScript, React, Next.js, Node.js, and cloud services. I believe the best code is the one that solves real problems in a simple and scalable way.",
  ],
};
